...
# Set up logging
logging.basicConfig(filename='24h_entsoe_day_ahead_total_load_forecast.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
failed_day_ahead_total_load_forecast = []


# Query day-ahead total load forecast and upload data to InfluxDB
for country_code in sorted_country_codes:
    try:
        ...
        failed_day_ahead_total_load_forecast.append(country_code)
...
print(failed_day_ahead_total_load_forecast)